                        ...
                        <div className="package-box">
                            ...
                            <div className="carousel">
                                <div className="week-container menu-container">
                                    <div className="swiper-wrapper">
                                        <div className="swiper-slide"><input type="radio" className="styled-checkbox" id="sat" name="weekday" /><label htmlFor="sat"><span>Sat</span>25 Sept</label></div>
                                        <div className="swiper-slide"><input type="radio" className="styled-checkbox" id="sun" name="weekday" /><label htmlFor="sun"><span>Sun</span>26 Sept</label></div>								
                                        <div className="swiper-slide"><input type="radio" className="styled-checkbox" id="mon" name="weekday" /><label htmlFor="mon"><span>Mon</span>27 Sept</label></div>
                                        <div className="swiper-slide"><input type="radio" className="styled-checkbox" id="tue" name="weekday" /><label htmlFor="tue"><span>Tue</span>28 Sept</label></div>								
                                        <div className="swiper-slide"><input type="radio" className="styled-checkbox" id="wed" name="weekday" /><label htmlFor="wed"><span>Wed</span>29 Sept</label></div>
                                        <div className="swiper-slide"><input type="radio" className="styled-checkbox" id="thu" name="weekday" /><label htmlFor="thu"><span>Thu</span>30 Sept</label></div>
                                    </div>
                                </div>
