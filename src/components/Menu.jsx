                            ...
                            <div class="carousel mb-3">
                                <div class="week-container menu-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide WEEK swiper-slide-active"><input type="radio" class="styled-checkbox" id="sat" name="weekday" checked value=""/><label for="sat">Sat</label></div>
                                        <div class="swiper-slide WEEK swiper-slide-active"><input type="radio" class="styled-checkbox" id="sun" name="weekday" value=""/><label for="sun">Sun</label></div>								
                                        <div class="swiper-slide WEEK "><input type="radio" class="styled-checkbox" id="mon" name="weekday" value=""/><label for="mon">Mon</label></div>
                                        <div class="swiper-slide WEEK"><input type="radio" class="styled-checkbox" id="tue" name="weekday" value=""/><label for="tue">Tue</label></div>								
                                        <div class="swiper-slide WEEK"><input type="radio" class="styled-checkbox" id="wed" name="weekday" value=""/><label for="wed">Wed</label></div>
                                        <div class="swiper-slide WEEK"><input type="radio" class="styled-checkbox" id="thu" name="weekday" value=""/><label for="thu">Thu</label></div>
                                    </div>
                                </div>
